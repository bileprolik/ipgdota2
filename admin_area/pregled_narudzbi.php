...
<table width="100%" align="center" bgcolor="#AFAFAF" >
    ...
    <tr align="center">
        <td colspan="9"><h2 style="color: grey;font-family: 'Bebas Neue Regular'">Pregled svih narudzbi</h2></td>
    </tr>
    ...
    while($row_pro = mysqli_fetch_array($run_pro)) {
        $id_narudzbe = $row_pro['id_narudzba'];
        ...
        $slika = $row_pro['slika'];
        $cena = $row_pro['cena'];
        $ukupna_cena = $row_pro['Ukupna_cena'];
        ...
        <td style="color: #969696;font-family: 'Bebas Neue Regular'"><?php echo $ukupna_cena?></td>
        <td style="color: #969696;font-family: 'Bebas Neue Regular'">Ime i prezime: <?php echo $ime.'     '.$prezime ?> <br /> E-mail: <?php echo $email ?> <br /> Grad : <?php echo $grad ?>
            ...
            <td colspan="" style="text-align:center;font-family: 'Bebas Neue Regular';color: #858585">
                ...
                ?></td>
            <td><a href="index.php?izmena_narudzbe=<?php echo $id_narudzbe; ?>">Izmeni</a></td>
