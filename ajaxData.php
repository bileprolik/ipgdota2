...

{
    ...
    $get_brands = "select  * from gume WHERE id_marka = 1 GROUP BY id_marka";
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 2 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 3 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 4 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 5 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 6 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
{
    echo "<option value=\"\">Izaberite visinu:</option>";
    $get_brands = "select  * from gume WHERE id_marka = 7 GROUP BY id_marka";
    $run_brands = mysqli_query($con, $get_brands);
...
if($_POST['visina']==1)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='1'>$sirina</option> ";
...
else if($_POST['visina']==2)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='2'>$sirina</option> ";
...
else if($_POST['visina']==3)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='3'>$sirina</option> ";
...
else if($_POST['visina']==4)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='4'>$sirina</option> ";
...
else if($_POST['visina']==5)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='5'>$sirina</option> ";
...
else if($_POST['visina']==6)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='6'>$sirina</option> ";
...
else if($_POST['visina']==7)
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<option value='7'>$sirina</option> ";
