...
imageArray[0].src = "gume/cor.jpg";
imageArray[0].imageCaption = "CORDIANT 205/65 R15 Winter Drive";
imageArray[0].imagePrice = "5.283,00 RSD";
imageArray[0].url = 'cordiant205.php';
imageArray[0].proizvodjac = 'CORDIANT';
imageArray[0].sirina = '205';
imageArray[0].visina = '65';
imageArray[0].precnik = '15';
imageArray[0].opterecenje = '85';
imageArray[0].indeks_brzine = 'V (230 km/h)';
