...
imageArray[0].imageCaption = "GOODYEAR 220/60 R19 Winter Drive";
imageArray[0].imagePrice = "12.232,00";
imageArray[0].url = 'goodyear.php';
imageArray[0].proizvodjac = 'MICHELIN';
imageArray[0].sirina = '220';
imageArray[0].visina = '60';
imageArray[0].precnik = '19';
imageArray[0].opterecenje = '90';
