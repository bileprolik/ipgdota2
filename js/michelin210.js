...
imageArray[0].imageCaption = "MICHELIN 220/35 R15 Winter Drive";
imageArray[0].imagePrice = "5.600,00 RSD";
imageArray[0].url = 'michelin.php';
imageArray[0].proizvodjac = 'MICHELIN';
imageArray[0].sirina = '220';
imageArray[0].visina = '35';
imageArray[0].precnik = '15';
imageArray[0].opterecenje = '80';
