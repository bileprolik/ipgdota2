...
imageArray[0].imageCaption = "SAVA 210/70 R13 Winter Drive";
imageArray[0].imagePrice = "8.799,00 RSD";
imageArray[0].url = 'sava.php';
imageArray[0].proizvodjac = 'SAVA';
imageArray[0].sirina = '210';
imageArray[0].visina = '70';
imageArray[0].precnik = '13';
imageArray[0].opterecenje = '60';
imageArray[0].indeks_brzine = 'V (190 km/h)';
...
function displayTigar225() {
    ...
    for (i=0;i<imageArray.length;i++) {
        document.write("" +
            ...
            "<br /><input type='number' size='' pattern='[0-9]*' inputmode='numeric' class='form-control input-lg text-center place-order-input unos' value='1' m in='1' max='99' name='unos' style='width: 100%'>" +
