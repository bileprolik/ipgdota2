...
starfireArray[0].imageCaption = "TIGAR 225/40 R18 WT200 88T";
starfireArray[0].imagePrice = "Cena : 4.123,00 RSD";
starfireArray[0].url = "tigar225.php";



starfireArray[1] = new Image();
starfireArray[1].src = "gume/tigar.jpg";
starfireArray[1].imageCaption = "TIGAR 225/40 R18 Wintera 92V XL TL";
starfireArray[1].imagePrice = "Cena : 6.623,00 RSD";
starfireArray[1].url = "tigar215.php";
