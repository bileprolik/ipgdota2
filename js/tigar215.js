...
imageArray[0].imageCaption = "TIGAR 215/35 R18 Wintera 80V XL TL";
imageArray[0].imagePrice = "6.623,00 RSD";
imageArray[0].url = 'tigar215.php';
imageArray[0].proizvodjac = 'TIGAR';
imageArray[0].sirina = '215';
imageArray[0].visina = '35';
imageArray[0].precnik = '18';
imageArray[0].opterecenje = '80';
imageArray[0].indeks_brzine = 'V (220 km/h)';
