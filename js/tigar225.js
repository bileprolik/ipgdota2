...
imageArray[0].imagePrice = "4.123,00 RSD";
imageArray[0].url = 'tigar225.php';
imageArray[0].proizvodjac = 'TIGAR';
imageArray[0].sirina = '225';
imageArray[0].visina = '40';
imageArray[0].precnik = '18';
imageArray[0].opterecenje = '92';
imageArray[0].indeks_brzine = 'V (240 km/h)';
...
function displayTigar225() {
    ...
    for (i=0;i<imageArray.length;i++) {
        document.write("" +
            ...
            "<tr>" +
            "<th colspan='2' style='text-align: center;background-color: orangered;color:white;font-size: 14px'>SPECIFIKACIJE ZA : TIGAR 225/40 R18 WINTER DRIVE 92V XL TL</th></tr>" +
