...
if( isset($_GET['email']) && !empty($_GET['email']) AND isset($_GET['hash']) && !empty($_GET['hash']) )
{
    ...
    {
        $_SESSION['message'] = "Uneli ste pogrešnu URL adresu!";
        header("location: error.php");
    }
}
else {
    $_SESSION['message'] = "Nažalost verifikacija nije uspela, pokušajte ponovo!";
    header("location: error.php");
}
?>
<html>
<head>
    <title>Internet Prodaja Guma - Reset</title>
    ...
    <title>Internet Prodaja Guma - Resetovanje Lozinke</title>
    <meta charset="utf-8">
...
<div class="form">
    ...
    <form action="reset_password.php" method="post">
        ...
        <div class="field-wrap">
            <label>
                Potvrdite novu lozinku<span class="req">*</span>
            </label>
        ...
        <button class="button button-block"/>Potvrdite</button>
