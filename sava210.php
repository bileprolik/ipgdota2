...
<head>
    ...
    <script src="js/sava210.js"></script>
</head>
<body>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            ...
                            <ul class="nav navbar-nav pull-right">
                                <a class="navbar-brand" style="background-color: rgba(255,69,0,0.75);color: white;"><span><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>ŠKOLSKI PROJEKAT</a>
                            </ul>
                        </div>
                    </div>
                </nav>
...
<div class="underheader" style="text-align: center;">
    <img src="slike/internet_prodaja_guma_besplatna_isporuka_desktop.png" class="img-responsive"   >
</div>
...
<br />
<div class="tire">
    <h5 class="col-md-offset-1" style="color: orangered;font-size: 24px"><b>SAVA 210/70 R15 Winter Drive</b></h5>
</div>
...
<div class="footer col-xs-12 col-sm-12 col-md-12 col-lg-12 " style="position: relative;">
    <img src="slike/rsz_1footer-bg.jpg" alt="footer" style='border-top: 2px solid orangered;border-bottom:2px solid orangered'>
